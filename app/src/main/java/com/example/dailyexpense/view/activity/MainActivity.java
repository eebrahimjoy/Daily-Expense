...
public class MainActivity extends AppCompatActivity {
    ...
    private void initRecyclerView() {
        ...
        dailyExpenseAdapter = new DailyExpenseAdapter(this, expenses);
